...
const std::string& toString(FlexibleInputLayoutDescription::ElementType elementType);
void fromString(FlexibleInputLayoutDescription::ElementType& elementType, const std::string& name);
